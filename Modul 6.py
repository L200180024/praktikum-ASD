...
class urut():
    ...
    def mergeSort(self, arr): 
        if len(arr) >1: 
            mid = len(arr)//2 #mencari tangah dari array 
            L = arr[:mid] # membagi elemen array  
            R = arr[mid:] # menjadi 2 bagian
  
            self.mergeSort(L) # Sorting bagian pertama
            self.mergeSort(R) # Sorting bagian kedua
...
mh1 = mahasiswa("dessy", 104, "boyolali", 30000)
mh2 = mahasiswa("nur", 84, "solo", 15000)
mh3 = mahasiswa("azizah", 124, "sukoharjo", 50000)
mh4 = mahasiswa("febri", 544, "klaten", 80000)
mh5 = mahasiswa("wisnu", 4, "kartasura", 14000)
